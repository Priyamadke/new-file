...
class DataOperations:                 # class for other data related operations
    def __init__(self, connection,connection1):   # constuctor here the previous class instance will be passed as a connection parameter ok.
        ...
        if self.connection is not None:
            try:
                ...
                cur.execute("""
                    ...
                    ('maNage*&#ment&','one 0 23qaero','iNdia'),
                    ('Da@@ta_te@m*','17','inDIA'),
                    ('M*&^%$l','five five','+99'),
...
def main():   # all done here is the driver function which will call above classes and it's functions.
    ...
    user = "postgres"
    host = "localhost"
    password = "priyansh12345"
    port = 5432
    database = "departments_data"
